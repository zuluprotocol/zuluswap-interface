...
import { useVotingInfo } from 'hooks/zuludao'
import { ProposalDetail, ProposalStatus } from 'hooks/zuludao/types'
import useTheme from 'hooks/useTheme'
import { ApplicationModal } from 'state/application/actions'
import { useToggleModal } from 'state/application/hooks'

import YourTransactionsModal from '../StakeZPX/YourTransactionsModal'
    ...
    <Wrapper>
      <RowBetween marginBottom={'10px'}>
        ...
        <Flex style={{ gap: '30px' }}>
          ...
          <TextButton href="https://gov.zulu.org/" target="_blank" rel="noreferrer">
            <ForumIcon />{' '}
          ...
          <TextButton
            href="https://docs.zuluswap.com/zulu-dao/zulu-dao-introduction"
            target="_blank"
            rel="noreferrer"
          >
            <FAQIcon />
