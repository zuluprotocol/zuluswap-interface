...
import { ReactComponent as ZPXSVG } from 'assets/svg/zpx_black.svg'
...
import ZuluSwapGeneralIntro from '../ZuluSwapGeneralIntro'
import {
  AboutZPX,
  AboutPage,
  BtnOutlined,
...
function AboutZuluSwap() {
  ...
  const Compounding = ({ width }: { width?: string }) => (
    ...
    >
      ...
      <ButtonEmpty padding="0" width="fit-content">
        <ExternalLink href="https://docs.zuluswap.com/overview/overview-zuluswap-elastic">
  ...
  const ForLPLowerSlippage = ({ width }: { width?: string }) => (
    ...
    >
      ...
      <Flex sx={{ gap: '24px' }} flexDirection="column" alignItems={above768 ? 'flex-start' : 'center'} flex={1}>
        ...
        <ButtonEmpty padding="0" width="fit-content">
          <ExternalLink href="https://docs.zuluswap.com/Classic/introduction">
      ...
      {above768 && (
        <Flex alignItems="center" width="fit-content">
          <ZuluSwapSlippage>
            <img src={isDarkMode ? '/logo-dark.svg' : '/logo.svg'} width="88px" alt="ZuluSwap" />
  ...
  const ForLPHigherReturn = ({ width }: { width?: string }) => (
    ...
    >
      ...
      <ButtonEmpty padding="0" width="fit-content">
        <ExternalLink href="https://docs.zuluswap.com/Classic/overview/dynamic-fee">
          <Text color={theme.primary} fontSize="14px" fontWeight={600} marginTop="24px">
            <Trans>Learn More</Trans>↗
          </Text>
        </ExternalLink>
  ...
  const renderDocsButton = () => {
    return (
      <BtnOutlined style={{ flex: '0 0 216px' }} as={ExternalLink} href="https://docs.zuluswap.com/">
      ...
      <AboutPage>
        ...
        <Wrapper>
          ...
          <OverflowStatisticWrapper>
            ...
            <Text fontStyle="italic" textAlign="right" fontSize="12px" marginTop="8px" color={theme.subText}>
              **<Trans>Applicable to ZuluSwap Classic</Trans>
            </Text>
          </OverflowStatisticWrapper>
            ...
            <Flex flex={1} flexDirection="column" height="max-content">
              ...
              >
                <Trans>
                  ...
                  ZuluSwap) and identify the best trade route for you.
                </Trans>
              </Text>
          ...
          >
            <Trans>
              ...
              passive income - ZuluSwap Elastic and ZuluSwap Classic. Simply deposit your liquidity and start earning.
            </Trans>
          </Text>
          ...
          >
            <Flex flex={1} flexDirection="column">
              ...
              <Text color={theme.text} marginTop={['40px', '48px']} lineHeight={1.5}>
                <Trans>Anyone can provide liquidity to ZuluSwap by depositing tokens e.g. Traders, Token Teams.</Trans>
              </Text>
              <Text color={theme.text} marginTop="24px" lineHeight={1.5}>
                <Trans>
                  Anyone can access this liquidity from ZuluSwap for their own use case e.g. Dapps, Aggregators.
                </Trans>
              </Text>
              <Text color={theme.text} marginTop="24px" lineHeight={1.5}>
                <Trans>
            ...
            >
              <div style={{ flex: 1, textAlign: 'center' }}>
                ...
                <ButtonEmpty padding="0">
                  <ExternalLink href="https://chainsecurity.com/security-audit/zuluswap-elastic">
                    <img
                      src={
                        !isDarkMode
          ...
          <AboutZPX>
            <img height="400px" src={ZPXGraphic} alt="ZPXGraphic" style={{ display: above768 ? 'block' : 'none' }} />
            <Flex width="100%" alignSelf="center" flexDirection="column" height="max-content">
              <Text fontSize={['16px', '20px']} fontWeight={500} color={theme.primary}>
                <Trans>ABOUT ZPX</Trans>
              </Text>
              <Text as="h2" marginTop="12px" fontSize={['28px', '36px']} fontWeight="500">
                <Trans>Zulu Network Crystal (ZPX)</Trans>
              </Text>
              <Text
                fontSize="16px"
                marginTop={['40px', '48px']}
              ...
              >
                <Trans>
                  ZPX is a utility and governance token, and an integral part of Zulu Network and its flagship product
                  ZuluSwap. It is the glue that connects different stakeholders in Zulu&apos;s ecosystem
                </Trans>
              </Text>
              <img
                width="75%"
              ...
              />
              <BtnPrimary as={Link} to="/about/zpx" margin="48px 0">
                <ZPXBlack />
          ...
          <Text as="h2" marginTop={['100px', '160px']} fontSize={['28px', '36px']} fontWeight="500" textAlign="center">
            ...
            <Powered>
              <img
                src={
                  isDarkMode
                    ? require('assets/svg/about_icon_zulu.svg').default
                    : require('assets/svg/about_icon_zulu_light.svg').default
                }
                alt="zulu_icon"
                width="100%"
              />
