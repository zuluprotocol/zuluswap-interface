...
const ZuluSwapGeneralIntro = () => {
  ...
  if (above768) {
    return (
      ...
      >
        {renderZuluSwapIntroDEX()}
        {renderZuluSwapIntroAMM()}
        {renderSwapNowButton()}
...
export default ZuluSwapGeneralIntro
