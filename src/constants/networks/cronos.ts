...
const cronosInfo: EVMNetworkInfo = {
  ...
  iconSelected: CRONOS,
  defaultBlockSubgraph: 'https://cronos-graph.zuluengineering.io/subgraphs/name/zulunetwork/cronos-blocks',
  ...
  classic: {
    defaultSubgraph: 'https://cronos-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-exchange-cronos',
    static: {
  ...
  elastic: {
    defaultSubgraph: 'https://cronos-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-elastic-cronos',
    startBlock: 3152290,
