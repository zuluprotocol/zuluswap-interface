...
const optimismInfo: EVMNetworkInfo = {
  ...
  classic: {
    defaultSubgraph: 'https://api.thegraph.com/subgraphs/name/zulunetwork/zuluswap-exchange-optimism',
    static: {
  ...
  elastic: {
    defaultSubgraph: 'https://api.thegraph.com/subgraphs/name/zulunetwork/zuluswap-elastic-optimism',
    startBlock: 12001267,
