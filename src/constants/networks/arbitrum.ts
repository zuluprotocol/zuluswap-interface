...
const arbitrumInfo: EVMNetworkInfo = {
  ...
  defaultBlockSubgraph: 'https://api.thegraph.com/subgraphs/name/zulunetwork/arbitrum-blocks',
  ...
  defaultRpcUrl: 'https://arbitrum.zuluengineering.io',
  ...
  classic: {
    defaultSubgraph:
      'https://arbitrum-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-exchange-arbitrum',
    static: {
  ...
  elastic: {
    defaultSubgraph: 'https://api.thegraph.com/subgraphs/name/zulunetwork/zuluswap-elastic-arbitrum-one',
    startBlock: 14137735,
