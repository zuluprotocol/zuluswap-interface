...
const ethereumInfo: EVMNetworkInfo = {
  ...
  defaultBlockSubgraph: 'https://ethereumpow-graph.zuluengineering.io/subgraphs/name/zulunetwork/ethereumpow-blocks',
  ...
  defaultRpcUrl: 'https://ethereumpow.zuluengineering.io',
  multicall: '0x5BA1e12693Dc8F9c48aAD8770482f4739bEeD696',
  classic: {
    defaultSubgraph:
      'https://ethereumpow-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-exchange-ethereumpow',
    static: {
  ...
  elastic: {
    defaultSubgraph:
      'https://ethereumpow-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-elastic-ethereumpow',
    startBlock: 14932475,
