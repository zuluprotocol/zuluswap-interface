...
const bttcInfo: EVMNetworkInfo = {
  ...
  defaultBlockSubgraph: 'https://bttc-graph.zuluengineering.io/subgraphs/name/zulunetwork/bttc-blocks',
  ...
  defaultRpcUrl: 'https://bttc.zuluengineering.io',
  multicall: '0xBF69a56D35B8d6f5A8e0e96B245a72F735751e54',
  classic: {
    defaultSubgraph: 'https://bttc-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-exchange-bttc',
    static: {
  ...
  elastic: {
    defaultSubgraph: 'https://bttc-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-elastic-bttc',
    startBlock: 7570793,
