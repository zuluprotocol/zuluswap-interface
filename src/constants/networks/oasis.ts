...
const oasisInfo: EVMNetworkInfo = {
  ...
  defaultBlockSubgraph: 'https://oasis-graph.zuluengineering.io/subgraphs/name/zulunetwork/oasis-blocks',
  ...
  defaultRpcUrl: 'https://oasis.zuluengineering.io',
  multicall: '0xBF69a56D35B8d6f5A8e0e96B245a72F735751e54',
  classic: {
    defaultSubgraph: 'https://oasis-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-exchange-oasis',
    static: {
  ...
  elastic: {
    defaultSubgraph: 'https://oasis-graph.zuluengineering.io/subgraphs/name/zulunetwork/zuluswap-elastic-oasis',
    startBlock: 1656923,
